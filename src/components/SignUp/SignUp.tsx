...
class SignUp extends React.Component<IProps, IState> {
  ...
  onSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    this.props.actionSignUp({ email, password, returnSecureToken });
  };
  ...
  render(): JSX.Element {
    ...
    return (
      <Form>
        <Alert
          color="primary"
          isOpen={!hideErrors && auth.errors != null}
        ...
        <FormGroup row>
          <Label for="email" sm="12" md={{ size: 6, offset: 3 }}>
            Email
          </Label>
          <Col sm="12" md={{ size: 6, offset: 3 }}>
            ...
            />
            <FormFeedback valid />
            <FormFeedback>Email not valid.</FormFeedback>
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="password" sm="12" md={{ size: 6, offset: 3 }}>
            Password
          </Label>
          <Col sm="12" md={{ size: 6, offset: 3 }}>
            <Input
            ...
            />
            <FormFeedback valid />
            <FormFeedback>Password not valid.</FormFeedback>
          </Col>
        </FormGroup>
        <FormGroup row>
          ...
          <Col sm="3" md={{ size: 1, offset: 1 }}>
            <Button color="primary" onClick={this.onSubmit} type="submit">
              Accedi
            </Button>
          </Col>
        </FormGroup>
