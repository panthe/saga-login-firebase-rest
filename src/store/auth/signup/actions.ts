...
export const actionSignUp = (params: AuthSignUpParams): AuthSignUpAction => {
...
export const actionSignUpRequest = (payload: AuthState): AuthSignUpAction => ({
  type: EAuthSignUpActionTypes.GET_AUTH_REGISTER_REQUEST,
  payload
});

export const actionSignUpSuccess = (payload: AuthState): AuthSignUpAction => ({
  type: EAuthSignUpActionTypes.GET_AUTH_REGISTER_SUCCESS,
  payload
});

export const actionSignUpFailure = (payload: AuthState): AuthSignUpAction => ({
