...
export const actionSignInRequest = (payload: AuthState): AuthSignInAction => ({
  type: EAuthSignInActionTypes.GET_AUTH_LOGIN_REQUEST,
  payload
});

export const actionSignInSuccess = (payload: AuthState): AuthSignInAction => ({
  type: EAuthSignInActionTypes.GET_AUTH_LOGIN_SUCCESS,
  payload
});

export const actionSignInFailure = (payload: AuthState): AuthSignInAction => ({
